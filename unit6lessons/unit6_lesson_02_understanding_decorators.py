...
def test_decorator_chaining():
    ...
    test_logs = []
    assert __ == increment(10)
    assert __ == increment.__name__
    assert [__] == test_logs
...
def test_decorators_wraps():
    ...
    assert __ == add.__name__
    assert __ == add.__doc__
    assert __ == add(10,20) # execution works fine
    ...
    assert __ == sub.__name__
    assert __ == sub.__doc__
    assert __ == sub(20, 10)
    ...
    assert __ == mult.__name__
    assert __ == mult.__doc__
    assert __ == mult(10,20)
